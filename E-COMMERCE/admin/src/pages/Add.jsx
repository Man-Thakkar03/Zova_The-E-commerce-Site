...
const Add = ({token}) => {
  ...
  className="flex flex-col w-full max-w-4xl mx-auto items-start gap-8 p-6 mt-4"
>
  {/* Image Upload */}
  ...
  <div className="w-full">
    ...
    <input
      ...
      value={name}
      className="w-full max-w-[500px] px-4 py-3 border border-pink-400 rounded focus:outline-none focus:ring-2 focus:ring-pink-500 transition"
      type="text"
  ...
  <div className="w-full">
    ...
    <textarea
      ...
      value={description}
      className="w-full max-w-[500px] px-4 py-3 border border-fuchsia-500 rounded focus:outline-none focus:ring-2 focus:ring-fuchsia-500 transition"
